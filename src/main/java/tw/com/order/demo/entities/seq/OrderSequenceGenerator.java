...
public class OrderSequenceGenerator extends SequenceStyleGenerator{
	
	public static final String STRATEGY = "tw.com.order.demo.entities.seq.OrderSequenceGenerator";
