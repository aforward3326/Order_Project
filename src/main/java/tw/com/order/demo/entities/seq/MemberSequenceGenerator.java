package tw.com.order.demo.entities.seq;
...
public class MemberSequenceGenerator extends SequenceStyleGenerator{
	
	public static final String STRATEGY = "tw.com.order.demo.entities.seq.MemberSequenceGenerator";
